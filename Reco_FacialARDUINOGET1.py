...
ser = serial.Serial('COM14', 9600)  # Reemplaza 'COM3' con el puerto correcto
...
while True:
    ...
    for face_encoding, (top, right, bottom, left) in zip(face_encodings, face_locations):
        ...
        if name == "Desconocido":
            ser.write(b'R')  # Enviar 'R' al Arduino para encender el LED rojo
        else:
            ser.write(b'G')  # Enviar 'G' al Arduino para encender el LED verde
