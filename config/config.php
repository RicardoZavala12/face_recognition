...
/** RUTAS PARA BOTONES**/
define('BTN_FACE_LIST','http://localhost/inte/index.php?controller=face&action=index');
define('BTN_ADMIN_LIST','http://localhost/inte/index.php?controller=admin&action=index');
define('BTN_USUARIO_LIST','http://localhost/inte/index.php?controller=usuario&action=index');
